...
//    }
   ...
   // out.println("Welcome: "+name+" ");
    ...
    String str="0";
    int fee=0;
    ResultSet res2=myStmt.executeQuery("SELECT * FROM STUDENT");
    ...
    while(res2.next()){
        ...
        out.println("<tr><td>"+stud_id+"</td><td>"+sname+"</td><td>"+gender+"</td><td>"+sports+"</td><td>"+batch+"</td><td>"+coaches+"</td><td>"+phone+"</td><td>"+fee+"</td><td>"+status+"</td></tr>");
        coaches="none";
        sports="none";
        batch="none";
    }
