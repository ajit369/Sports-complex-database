...
try{
    ...
    int columnCount=metadata.getColumnCount();
     int count=0;
     out.println("<form action='admin_change_details_maintenance_delete_last.jsp'>");
     out.println("<h1 style='color: purple'><b>Type a maintenance staff_id to delete</b></h1>");
