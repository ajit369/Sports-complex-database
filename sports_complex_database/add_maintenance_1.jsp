...
<body>
 <div>Sign_up_maintenance</div>
         <form action="add_maintenance_2.jsp" >
  ...
  <div class="container">
    ...
    <br> 
	  <label for="work" style='font-weight: bold'>Working_hrs_per_day</label>
      <input type="text" name="work" id="work" required>
	  <br>
	  <label for="loc_id"><b>loc_id</b></label>
    <input type="text" placeholder="loc_id" name="loc_id" id="loc_id" required>
	  <br>
  <br>
	  <div class="clearfix">	
