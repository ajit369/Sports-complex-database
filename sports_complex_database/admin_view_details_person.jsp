...
//    }
   ...
   // out.println("Welcome: "+name+" ");
    ...
    String phone="none";
    String drink="none";
    ResultSet res2=myStmt.executeQuery("SELECT * FROM SPORTS_PERSON");
    ...
    while(res2.next()){
        ...
        out.println("<tr><td>"+person_id+"</td><td>"+person_name+"</td><td>"+gender+"</td><td>"+sports+"</td><td>"+fee+"</td><td>"+status+"</td><td>"+phone+"</td><td>"+drink+"</td></tr>");
        sports="none";
        phone="none";
        drink="none";
    }
