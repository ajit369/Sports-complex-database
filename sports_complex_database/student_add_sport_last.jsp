...
<body>
<center>
	<h1 id='suc'> You have successfully added a sport!!!</h1>
...
//response.setContentType("text/html;charset=UTF-8");
    ...
    //   res=myStmt.executeQuery("SELECT COUNT(username) FROM STUDENT WHERE username='"+name+"'");
      // ResultSetMetaData metadata=res.getMetaData();
       ...
       int stud_id=0;
       ResultSet res3=myStmt.executeQuery("SELECT STUDENT_ID FROM STUDENT WHERE USERNAME='"+uname+"'");
       while(res3.next())
       {
       ...
       out.println("<center><h1 style='color: green'>CONGRATULATIONS! You have successfully added a sport</h1></center>");
       String time="0";
