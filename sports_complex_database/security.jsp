...
try{
    ...
    res=myStmt.executeQuery("SELECT COUNT(username) FROM SECURITY WHERE username='"+name+"'and password='"+pass+"'");
...
//    }
    ...
    String shift="0";
    int loc_id=0;
    ResultSet res2=myStmt.executeQuery("SELECT * FROM SECURITY WHERE USERNAME='"+name+"' AND PASSWORD='"+pass+"'");
    while(res2.next()){
    	id=res2.getInt("SEC_ID");
    	sec_name=res2.getString("SEC_NAME");
    ...
    out.println("<center><table><tr><th>ID</th><td>"+id+"</td></tr><tr><th>Name</th><td>"+sec_name+"</td></tr><tr><th>Location ID</th><td>"+loc_id+"</td></tr><tr><th>Location</th><td>"+loc_name+"</td></tr><tr><th>Shift</th><td>"+shift+"</td></tr><tr><th>Salary</th><td>"+sal+"</td></tr></table>");
