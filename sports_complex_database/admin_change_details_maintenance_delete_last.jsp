...
try{
    ...
    int columnCount=metadata.getColumnCount();
     int count=0;
     res=myStmt.executeQuery("SELECT COUNT(M_ID) FROM MAINTENANCE_STAFF WHERE M_ID="+change_id);
     while(res.next())
     {
    	 count=res.getInt(1);
     }
     if(count==0)
     {
    	 ...
    	 out.println("<h1 style='color:red'>There are no persons available with this id</h1>");
    	 ...
    	 myStmt.executeUpdate("DELETE FROM MAINTENANCE_STAFF WHERE M_ID="+change_id);
    	 out.println("<form action='admin_change_details.jsp'>");
