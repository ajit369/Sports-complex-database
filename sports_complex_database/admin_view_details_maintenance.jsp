...
//    }
   ...
   // out.println("Welcome: "+name+" ");
    ...
    int check=0;  
    String str=null;
    ResultSet res2=myStmt.executeQuery("SELECT * FROM MAINTENANCE_STAFF");
    out.println("<center><table><tr><th>ID</th><th>Name</th><th>Salary</th><th>Location</th><th>Working_hrs_per_day</th></tr>");
    while(res2.next()){
    	loc_id=res2.getInt("LOC_ID");
    	hrs=res2.getInt("WORKING_HRS_PER_DAY");
    	id=res2.getInt("M_ID");
    	mname=res2.getString("M_NAME");
    	ResultSet res5=myStmt1.executeQuery("SELECT M_SALARY FROM MAINTENANCE_STAFF_SAL WHERE LOC_ID="+loc_id+" AND WORKING_HRS_PER_DAY="+hrs);
    	while(res5.next()){
    	sal=res5.getInt("M_SALARY");
    	}
        ...
        out.println("<tr><td>"+id+"</td><td>"+mname+"</td><td>"+sal+"</td><td>"+loc_name+"</td><td>"+hrs+"</td></tr>");
