...
//response.setContentType("text/html;charset=UTF-8");
       ...
       ResultSet res4=myStmt.executeQuery("select count(*) from plays where person_id="+id+" and sports_name='"+sport+"'");
    	...
    	if(count!=0){
    		out.println("<center><h1>U ARE ALREADY REGISTERED TO THAT SPORT</h1></center>");
    	}
    	else{
    		myStmt.executeUpdate("insert into plays values ('"+sport+"',"+id+")");
    	   ...
    	   out.println("<h1 id='suc'><center>You have successfully added a sport!!!</center></h1>");
    	}
